...
export const UserMultipleIcon = /*#__PURE__*/forwardRef(({
  ...
  d: "M19.51 20.3h-.49c-.5 0-.9-.4-.9-.9s.4-.9.9-.9h.49c.78 0 1.49-.32 2.29-1.03.237-.208.21-.288.2-.32-.3-.78-2.86-1.85-4.09-1.85-.5 0-.9-.4-.9-.9s.4-.9.9-.9c1.41 0 5.06 1.14 5.77 3.01.31.81.06 1.65-.68 2.3-1.14 1.01-2.24 1.48-3.49 1.48v.01Zm-2.91-9c-.3 0-.6-.03-.88-.09-.49-.1-.8-.57-.71-1.06a.9.9 0 0 1 1.06-.71c.17.03.35.05.53.05 1.32 0 2.4-.94 2.4-2.1 0-1.16-1.07-2.1-2.4-2.1-.18 0-.36.02-.53.05-.48.1-.96-.22-1.06-.71a.9.9 0 0 1 .71-1.06c.29-.06.58-.09.88-.09 2.31 0 4.19 1.75 4.19 3.9s-1.88 3.9-4.19 3.9v.02Z"
}), /*#__PURE__*/React.createElement("path", {
