...
const MoneySendSquare = React.forwardRef(function MoneySendSquare(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
