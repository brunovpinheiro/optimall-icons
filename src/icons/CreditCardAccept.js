...
const CreditCardAccept = React.forwardRef(function CreditCardAccept(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
