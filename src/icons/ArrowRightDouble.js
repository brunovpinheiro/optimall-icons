...
const ArrowRightDouble = React.forwardRef(function ArrowRightDouble(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
