...
const MoneyReceiveSquare = React.forwardRef(function MoneyReceiveSquare(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
