...
const CheckboxIndeterminate = React.forwardRef(function CheckboxIndeterminate(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
