...
const ArrowRightDown = React.forwardRef(function ArrowRightDown(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
