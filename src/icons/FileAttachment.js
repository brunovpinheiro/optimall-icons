...
const FileAttachment = React.forwardRef(function FileAttachment(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
