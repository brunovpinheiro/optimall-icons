...
const ArrowLeftDouble = React.forwardRef(function ArrowLeftDouble(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
