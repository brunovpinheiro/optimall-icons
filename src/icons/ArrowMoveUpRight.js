...
const ArrowMoveUpRight = React.forwardRef(function ArrowMoveUpRight(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
