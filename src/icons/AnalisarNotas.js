...
const AnalisarNotas = React.forwardRef(function AnalisarNotas(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
