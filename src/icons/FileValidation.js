...
const FileValidation = React.forwardRef(function FileValidation(props, ref) {
  const {
    size = 24,
    color = 'currentColor',
    strokeWidth = 2,
