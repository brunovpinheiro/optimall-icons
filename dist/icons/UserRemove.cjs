...
var UserRemove_exports = {};
__export(UserRemove_exports, {
  UserRemove: () => UserRemove,
  default: () => UserRemove_default
});
module.exports = __toCommonJS(UserRemove_exports);
...
//# sourceMappingURL=UserRemove.cjs.map