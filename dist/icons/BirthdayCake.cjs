...
var BirthdayCake_exports = {};
__export(BirthdayCake_exports, {
  BirthdayCake: () => BirthdayCake,
  default: () => BirthdayCake_default
});
module.exports = __toCommonJS(BirthdayCake_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var BirthdayCake = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
