...
var UserMultiple = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", fillRule: "evenodd", d: "M4.5 6.9c0 2.7 2.2 4.9 4.9 4.9s4.9-2.2 4.9-4.9S12.1 2 9.4 2 4.5 4.2 4.5 6.9m1.8 0c0-1.71 1.39-3.1 3.1-3.1s3.1 1.39 3.1 3.1S11.11 10 9.4 10 6.3 8.61 6.3 6.9", clipRule: "evenodd" }),
...
export {
  UserMultiple,
  UserMultiple_default as default
};
//# sourceMappingURL=UserMultiple.js.map