...
var ReceiptPrint_exports = {};
__export(ReceiptPrint_exports, {
  ReceiptPrint: () => ReceiptPrint,
  default: () => ReceiptPrint_default
});
module.exports = __toCommonJS(ReceiptPrint_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var ReceiptPrint = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: "currentColor", d: "M8.9 10.8h3c.5 0 .9-.4.9-.9s-.4-.9-.9-.9h-3c-.5 0-.9.4-.9.9s.4.9.9.9m-1 2.2h6c.5 0 .9.4.9.9s-.4.9-.9.9h-6c-.5 0-.9-.4-.9-.9s.4-.9.9-.9" }),
...
var ReceiptPrint_default = ReceiptPrint;
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  ReceiptPrint
});
//# sourceMappingURL=ReceiptPrint.cjs.map