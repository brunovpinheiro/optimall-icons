...
var ClubePodi_exports = {};
__export(ClubePodi_exports, {
  ClubePodi: () => ClubePodi,
  default: () => ClubePodi_default
});
module.exports = __toCommonJS(ClubePodi_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var ClubePodi = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
