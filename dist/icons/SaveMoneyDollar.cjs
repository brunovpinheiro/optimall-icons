...
var SaveMoneyDollar_exports = {};
__export(SaveMoneyDollar_exports, {
  SaveMoneyDollar: () => SaveMoneyDollar,
  default: () => SaveMoneyDollar_default
});
module.exports = __toCommonJS(SaveMoneyDollar_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var SaveMoneyDollar = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
