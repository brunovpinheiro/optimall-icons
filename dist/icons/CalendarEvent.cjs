...
var CalendarEvent_exports = {};
__export(CalendarEvent_exports, {
  CalendarEvent: () => CalendarEvent,
  default: () => CalendarEvent_default
});
module.exports = __toCommonJS(CalendarEvent_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var CalendarEvent = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
...
//# sourceMappingURL=CalendarEvent.cjs.map