...
var Apple = React.forwardRef(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: "currentColor", fillRule: "evenodd", d: "M16.3 1.9c0 2.37-1.77 4.9-4.4 4.9-.5 0-.9-.4-.9-.9C11 3.53 12.77 1 15.4 1c.5 0 .9.4.9.9m-2.04 1.23c-.25.64-.67 1.21-1.23 1.55.25-.64.67-1.21 1.23-1.55", clipRule: "evenodd" }),
