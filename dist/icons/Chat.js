...
var Chat = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M15.9 13.15a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5m-4 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5m-3.99 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5" })
  ] });
});
