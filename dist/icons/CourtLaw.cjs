...
var CourtLaw_exports = {};
__export(CourtLaw_exports, {
  CourtLaw: () => CourtLaw,
  default: () => CourtLaw_default
});
module.exports = __toCommonJS(CourtLaw_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var CourtLaw = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
