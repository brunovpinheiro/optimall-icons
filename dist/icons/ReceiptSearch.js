...
var ReceiptSearch = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M7 10.9c0-.5.4-.9.9-.9h4c.5 0 .9.4.9.9s-.4.9-.9.9h-4c-.5 0-.9-.4-.9-.9m9.8-4c0-.5-.4-.9-.9-.9h-8c-.5 0-.9.4-.9.9s.4.9.9.9h8c.5 0 .9-.4.9-.9" }),
...
export {
  ReceiptSearch,
  ReceiptSearch_default as default
};
//# sourceMappingURL=ReceiptSearch.js.map