...
var Tools2_exports = {};
__export(Tools2_exports, {
  Tools2: () => Tools2,
  default: () => Tools2_default
});
module.exports = __toCommonJS(Tools2_exports);
...
var Tools2 = React.forwardRef(({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: "currentColor", d: "M4.5 18.5c0-.55.45-1 1-1s1 .45 1 1-.45 1-1 1-1-.45-1-1" }),
...
//# sourceMappingURL=Tools2.cjs.map