...
var MapPin = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", fillRule: "evenodd", d: "M7.5 10.9a4.4 4.4 0 1 0 8.8 0 4.4 4.4 0 0 0-8.8 0m1.8 0c0-1.43 1.17-2.6 2.6-2.6s2.6 1.17 2.6 2.6-1.17 2.6-2.6 2.6-2.6-1.17-2.6-2.6", clipRule: "evenodd" }),
