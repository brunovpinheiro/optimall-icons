...
__export(FileValidation_exports, {
  ...
  default: () => FileValidation_default
});
module.exports = __toCommonJS(FileValidation_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var FileValidation = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
