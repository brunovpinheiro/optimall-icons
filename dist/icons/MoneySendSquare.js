...
var MoneySendSquare = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M16.9 8.8c-.23 0-.46-.09-.64-.26a.9.9 0 0 1 0-1.27l3.36-3.36-2.23-.1a.897.897 0 0 1-.86-.94c.02-.5.46-.88.94-.86l3.12.15c1.28.09 2.09.93 2.09 2.14l.12 3.06c.02.5-.37.91-.87.93-.49.04-.91-.37-.93-.87l-.09-2.26-3.38 3.38c-.18.18-.41.26-.64.26z" })
  ] });
});
...
export {
  MoneySendSquare,
  MoneySendSquare_default as default
};
//# sourceMappingURL=MoneySendSquare.js.map