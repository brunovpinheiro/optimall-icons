...
var GiftCheck_exports = {};
__export(GiftCheck_exports, {
  GiftCheck: () => GiftCheck,
  default: () => GiftCheck_default
});
module.exports = __toCommonJS(GiftCheck_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var GiftCheck = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
...
var GiftCheck_default = GiftCheck;
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  GiftCheck
});
//# sourceMappingURL=GiftCheck.cjs.map