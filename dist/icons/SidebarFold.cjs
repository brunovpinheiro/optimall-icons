...
var SidebarFold_exports = {};
__export(SidebarFold_exports, {
  SidebarFold: () => SidebarFold,
  default: () => SidebarFold_default
});
module.exports = __toCommonJS(SidebarFold_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var SidebarFold = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
