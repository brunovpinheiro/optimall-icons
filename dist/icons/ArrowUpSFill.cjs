...
var ArrowUpSFill_exports = {};
__export(ArrowUpSFill_exports, {
  ArrowUpSFill: () => ArrowUpSFill,
  default: () => ArrowUpSFill_default
});
module.exports = __toCommonJS(ArrowUpSFill_exports);
...
//# sourceMappingURL=ArrowUpSFill.cjs.map