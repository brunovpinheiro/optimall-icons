...
__export(ShoppingBasket_exports, {
  ...
  default: () => ShoppingBasket_default
});
module.exports = __toCommonJS(ShoppingBasket_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var ShoppingBasket = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
...
//# sourceMappingURL=ShoppingBasket.cjs.map