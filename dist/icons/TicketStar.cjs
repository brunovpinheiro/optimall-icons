...
var TicketStar_exports = {};
__export(TicketStar_exports, {
  TicketStar: () => TicketStar,
  default: () => TicketStar_default
});
module.exports = __toCommonJS(TicketStar_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var TicketStar = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
...
//# sourceMappingURL=TicketStar.cjs.map