...
__export(Backoffice_exports, {
  ...
  default: () => Backoffice_default
});
module.exports = __toCommonJS(Backoffice_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var Backoffice = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
