...
var FileValidation = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M18.6 4.55c-1.04.37-2.07 1.49-2.73 2.34-.43-.35-.82-.39-.97-.39-.5 0-.9.4-.9.9 0 .44.31.8.73.88.05.04.19.17.37.52.15.29.44.48.76.5h.05c.31 0 .59-.16.76-.42.59-.93 1.77-2.36 2.54-2.63.47-.17.71-.68.55-1.15a.907.907 0 0 0-1.15-.55z" }),
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M16.9 1A5.91 5.91 0 0 0 11 6.9c0 3.25 2.65 5.9 5.9 5.9s5.9-2.65 5.9-5.9S20.15 1 16.9 1m0 10c-2.26 0-4.1-1.84-4.1-4.1s1.84-4.1 4.1-4.1S21 4.64 21 6.9 19.16 11 16.9 11" })
  ] });
});
...
export {
  FileValidation,
  FileValidation_default as default
};
