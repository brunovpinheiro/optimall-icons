...
var ReceiptPrint = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M8.9 10.8h3c.5 0 .9-.4.9-.9s-.4-.9-.9-.9h-3c-.5 0-.9.4-.9.9s.4.9.9.9m-1 2.2h6c.5 0 .9.4.9.9s-.4.9-.9.9h-6c-.5 0-.9-.4-.9-.9s.4-.9.9-.9" }),
...
export {
  ReceiptPrint,
  ReceiptPrint_default as default
};
//# sourceMappingURL=ReceiptPrint.js.map