...
var Camera = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", fillRule: "evenodd", d: "M11.9 9.5a4.4 4.4 0 1 0 0 8.8 4.4 4.4 0 0 0 0-8.8m0 7c-1.43 0-2.6-1.17-2.6-2.6s1.17-2.6 2.6-2.6 2.6 1.17 2.6 2.6-1.17 2.6-2.6 2.6", clipRule: "evenodd" }),
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M12.81 5.9c0 .5-.4.9-.9.9-.49 0-.9-.4-.9-.9s.4-.9.9-.9.9.4.9.9" }),
