...
var MailSend_exports = {};
__export(MailSend_exports, {
  MailSend: () => MailSend,
  default: () => MailSend_default
});
module.exports = __toCommonJS(MailSend_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var MailSend = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
