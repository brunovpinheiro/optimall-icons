...
var PaintBoard = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M6.905 15.8h.005-.01zm.172-.017c-.06.009-.112.017-.172.017a.91.91 0 0 1-.875-.7c-.11-.49.19-.96.68-1.07.48-.11.97.2 1.07.68.11.49-.2.97-.68 1.07z" }),
...
export {
  PaintBoard,
  PaintBoard_default as default
};
//# sourceMappingURL=PaintBoard.js.map