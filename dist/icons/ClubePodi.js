...
var ClubePodi = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M12.11 18.32h-.02c-.36 0-.7.15-.95.41-.25.25-.39.6-.38.95 0 .36.14.7.39.95s.59.39.95.4c.18 0 .36-.04.53-.11a1.37 1.37 0 0 0 .85-1.28c-.02-.71-.65-1.31-1.37-1.31z" })
  ] });
});
...
export {
  ClubePodi,
  ClubePodi_default as default
};
//# sourceMappingURL=ClubePodi.js.map