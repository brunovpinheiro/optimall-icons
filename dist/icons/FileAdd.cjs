...
var FileAdd_exports = {};
__export(FileAdd_exports, {
  FileAdd: () => FileAdd,
  default: () => FileAdd_default
});
module.exports = __toCommonJS(FileAdd_exports);
var React = __toESM(require("react"), 1);
var import_jsx_runtime = require("react/jsx-runtime");
var FileAdd = React.forwardRef(({
  size = 24,
  color = "currentColor",
  strokeWidth = 2,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { fill: "currentColor", d: "M7 9.9c0 .5.4.9.9.9s.9-.4.9-.9V6.8h3.1c.5 0 .9-.4.9-.9s-.4-.9-.9-.9H8.8V1.9c0-.5-.4-.9-.9-.9s-.9.4-.9.9V5H3.9c-.5 0-.9.4-.9.9s.4.9.9.9H7z" }),
