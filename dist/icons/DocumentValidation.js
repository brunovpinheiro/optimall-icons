...
var DocumentValidation = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M15.88 9.32h-.05a.93.93 0 0 1-.76-.5c-.42-.84-.83-1.27-.84-1.27a.91.91 0 0 1 .01-1.27.9.9 0 0 1 1.27 0c.03.03.2.2.43.51.67-.84 1.64-1.87 2.64-2.22.47-.17.98.08 1.15.55s-.08.98-.55 1.15c-.77.27-1.95 1.7-2.54 2.63-.17.26-.45.42-.76.42" }),
...
export {
  DocumentValidation,
  DocumentValidation_default as default
};
