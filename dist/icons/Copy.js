...
var Copy = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M8.75 11.84c.05.01.11.01.16.01H8.9c.42 0 .8-.3.88-.74.18-.97.73-1.11 1.63-1.27l.12-.02a.89.89 0 0 0 .73-1.04.89.89 0 0 0-1.04-.73l-.11.02c-.87.15-2.69.47-3.09 2.73-.09.49.24.95.73 1.04" })
  ] });
});
