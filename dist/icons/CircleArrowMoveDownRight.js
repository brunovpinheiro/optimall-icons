...
var CircleArrowMoveDownRight = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", fillRule: "evenodd", d: "M9.18 1.471C3.363 3.03-.087 9.006 1.471 14.821s7.535 9.266 13.35 7.708 9.265-7.535 7.707-13.35S14.994-.087 9.179 1.47M3.21 14.355a9.1 9.1 0 1 1 17.58-4.71 9.1 9.1 0 0 1-17.58 4.71", clipRule: "evenodd" }),
...
export {
  ...
  CircleArrowMoveDownRight_default as default
};
//# sourceMappingURL=CircleArrowMoveDownRight.js.map