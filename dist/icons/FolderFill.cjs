...
var FolderFill_exports = {};
__export(FolderFill_exports, {
  FolderFill: () => FolderFill,
  default: () => FolderFill_default
});
module.exports = __toCommonJS(FolderFill_exports);
...
//# sourceMappingURL=FolderFill.cjs.map