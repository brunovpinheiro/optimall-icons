...
var ChatSquareCheck = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    ...
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M15.9 8.8h-.05a.93.93 0 0 1-.76-.5c-.68-1.37-1.27-1.51-1.28-1.51-.5 0-.86-.4-.86-.9s.44-.9.94-.9c.2 0 1.09.07 2.03 1.26 1.17-1.63 3.44-4.42 5.67-5.21.47-.17.98.08 1.15.55s-.08.98-.55 1.15c-2.07.73-4.7 4.32-5.54 5.63-.17.26-.45.42-.76.42z" })
  ] });
});
...
export {
  ChatSquareCheck,
  ChatSquareCheck_default as default
};
//# sourceMappingURL=ChatSquareCheck.js.map