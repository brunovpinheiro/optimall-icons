...
var CheckmarkBadge = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M10.1 15.07a.9.9 0 0 0 .6.23h.07a.9.9 0 0 0 .62-.32l4.2-5c.32-.38.27-.95-.11-1.27a.903.903 0 0 0-1.27.11l-3.6 4.29-1.11-.99a.9.9 0 0 0-1.2 1.34z" }),
...
export {
  CheckmarkBadge,
  CheckmarkBadge_default as default
};
//# sourceMappingURL=CheckmarkBadge.js.map