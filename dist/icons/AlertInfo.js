...
var AlertInfo = React.forwardRef(({
  ...
  return /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "none", viewBox: "0 0 24 24", role: "img", stroke: color, strokeWidth: computedStrokeWidth, className, ref, ...props, children: [
    /* @__PURE__ */ jsx("path", { fill: "currentColor", d: "M11.242 11.1c.21 0 .46-.002.67.026.205.028.474.096.718.292l.102.092.092.102c.196.244.264.512.292.719.028.21.027.459.027.669v4a.9.9 0 0 1-1.801 0v-4l-.001-.1h-.099a.9.9 0 0 1 0-1.8m.758-3a.9.9 0 0 1 0 1.8h-.008a.9.9 0 0 1 0-1.8z" }),
...
export {
  AlertInfo,
  AlertInfo_default as default
};
//# sourceMappingURL=AlertInfo.js.map