...
var ShakeHands_exports = {};
__export(ShakeHands_exports, {
  ShakeHands: () => ShakeHands,
  default: () => ShakeHands_default
});
module.exports = __toCommonJS(ShakeHands_exports);
...
//# sourceMappingURL=ShakeHands.cjs.map