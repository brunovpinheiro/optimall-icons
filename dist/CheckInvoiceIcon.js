...
export const CheckInvoiceIcon = /*#__PURE__*/forwardRef(({
  ...
  fill: "currentColor",
  d: "M10.9 11.8h-4c-.5 0-.9-.4-.9-.9s.4-.9.9-.9h4c.5 0 .9.4.9.9s-.4.9-.9.9m4-4h-8c-.5 0-.9-.4-.9-.9s.4-.9.9-.9h8c.5 0 .9.4.9.9s-.4.9-.9.9m1 14.5h-.03a.875.875 0 0 1-.8-.57c-.85-2.13-2.55-3.02-2.57-3.03a.9.9 0 0 1-.39-1.21c.22-.44.76-.62 1.2-.4.07.04 1.46.75 2.59 2.39 1.18-2.1 3.44-5.64 5.71-6.44.47-.17.98.08 1.15.55s-.08.98-.55 1.15c-1.8.64-4.33 4.66-5.49 7.05-.15.31-.47.5-.81.5z"
})));
