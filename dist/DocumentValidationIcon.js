...
export const DocumentValidationIcon = /*#__PURE__*/forwardRef(({
  ...
  fill: "currentColor",
  d: "M15.88 9.32h-.05a.93.93 0 0 1-.76-.5c-.42-.84-.83-1.27-.84-1.27a.91.91 0 0 1 .01-1.27.9.9 0 0 1 1.27 0c.03.03.2.2.43.51.67-.84 1.64-1.87 2.64-2.22.47-.17.98.08 1.15.55s-.08.98-.55 1.15c-.77.27-1.95 1.7-2.54 2.63-.17.26-.45.42-.76.42"
  ...
  fill: "currentColor",
  d: "M16.9 12.82c-3.26 0-5.91-2.65-5.91-5.9s2.65-5.9 5.91-5.9 5.91 2.65 5.91 5.9-2.65 5.9-5.91 5.9m0-10c-2.26 0-4.1 1.84-4.1 4.1s1.84 4.1 4.1 4.1S21 9.18 21 6.92s-1.84-4.1-4.1-4.1m-6.02 11h-4c-.5 0-.9-.4-.9-.9s.4-.9.9-.9h4c.5 0 .9.4.9.9s-.4.9-.9.9m4 4h-8c-.5 0-.9-.4-.9-.9s.4-.9.9-.9h8c.5 0 .9.4.9.9s-.4.9-.9.9"
})));
