...
export const AnalisarNotasIcon = /*#__PURE__*/forwardRef(({
  className,
  style,
  ariaLabel,
  ...props
  ...
  fill: "currentColor",
  d: "M11.91 9.9c-.55 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1"
}), /*#__PURE__*/React.createElement("path", {
  fill: "currentColor",
  fillRule: "evenodd",
  d: "M6.52 9.99c.71-1.01 2.67-3.34 5.38-3.34s4.66 2.34 5.38 3.34l.005.007c.179.248.365.507.365.903s-.186.655-.365.903l-.005.007c-.71 1.01-2.68 3.34-5.38 3.34s-4.66-2.34-5.38-3.34l-.005-.007c-.179-.248-.365-.507-.365-.903s.186-.655.365-.903zm5.38 3.66c2.01 0 3.58-1.9 4.16-2.71.01-.01.03-.03.03-.04-.01-.01-.03-.04-.03-.04-.58-.82-2.15-2.71-4.16-2.71s-3.58 1.9-4.16 2.71c-.01.01-.03.03-.03.04l.015.02.015.02c.58.82 2.15 2.71 4.16 2.71",
  clipRule: "evenodd"
}), /*#__PURE__*/React.createElement("path", {
  fill: "currentColor",
  fillRule: "evenodd",
