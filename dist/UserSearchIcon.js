...
export const UserSearchIcon = /*#__PURE__*/forwardRef(({
  ...
  fill: "currentColor",
  fillRule: "evenodd",
  d: "M21.26 22.54a.94.94 0 0 0 .635.26.9.9 0 0 0 .635-.26.9.9 0 0 0 0-1.27l-1.28-1.28c.48-.71.75-1.56.75-2.48 0-2.48-2.02-4.5-4.5-4.5s-4.5 2.02-4.5 4.5 2.02 4.5 4.5 4.5c.92 0 1.77-.28 2.48-.75zM14.8 17.5c0-1.49 1.21-2.7 2.7-2.7s2.7 1.21 2.7 2.7-1.21 2.7-2.7 2.7-2.7-1.21-2.7-2.7",
  clipRule: "evenodd"
})));
